...
import AvishaRobot
import AvishaRobot.modules.sql.welcome_sql as sql
...
from AvishaRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from AvishaRobot.modules.helper_funcs.msg_types import get_welcome_type
from AvishaRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from AvishaRobot.modules.log_channel import loggable
from AvishaRobot.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not AvishaRobot.ALLOW_CHATS:
