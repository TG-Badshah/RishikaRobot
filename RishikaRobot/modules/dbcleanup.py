...
import RishikaRobot.modules.sql.global_bans_sql as gban_sql
import RishikaRobot.modules.sql.users_sql as user_sql
from RishikaRobot import DEV_USERS, OWNER_ID, dispatcher
