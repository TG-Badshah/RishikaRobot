...
import RishikaRobot.modules.sql.blsticker_sql as sql
...
from RishikaRobot.modules.helper_funcs.alternate import send_message
from RishikaRobot.modules.helper_funcs.chat_status import user_admin, user_not_admin
from RishikaRobot.modules.helper_funcs.misc import split_message
...
from RishikaRobot.modules.warns import warn
...
def blackliststicker(update: Update, context: CallbackContext):
    ...
    sticker_list = "<b>List blacklisted stickers ᴄᴜʀʀᴇɴᴛʟʏ in {}:</b>\n".format(
        chat_name
    )
...
__help__ = """
 ...
 ⬤ /blstickermode <ʙᴀɴ/ᴛʙᴀɴ/ᴍᴜᴛᴇ/ᴛᴍᴜᴛᴇ>* ➥* sᴇᴛs ᴜᴘ ᴀ ᴅᴇғᴀᴜʟᴛ ᴀᴄᴛɪᴏɴ ᴏɴ ᴡʜᴀᴛ ᴛᴏ ᴅᴏ ɪғ ᴜsᴇʀs ᴜsᴇ ʙʟᴀᴄᴋʟɪsᴛᴇᴅ sᴛɪᴄᴋᴇʀsɴᴏᴛᴇ:
