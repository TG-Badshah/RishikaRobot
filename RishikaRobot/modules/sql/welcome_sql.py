...
from RishikaRobot.modules.helper_funcs.msg_types import Types
from RishikaRobot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    "✦ {first} ɪs ʜᴇʀᴇ !",
    "✦ ʀᴇᴀᴅʏ ᴘʟᴀʏᴇʀ {first}",
    "✦ {first} ᴊᴜsᴛ ᴊᴏɪɴᴇᴅ. ᴄᴀɴ ɪᴛ ɢᴇᴛ ᴀ ʜᴇᴀʟ ?",
]
DEFAULT_GOODBYE_MESSAGES = [
    "✦ {first} ʜᴀs ʟᴇғᴛ ᴛʜᴇ ɢʀᴏᴜᴘ.",
    "✦ ɴɪᴄᴇ ᴛᴏ ᴋɴᴏᴡɪɴɢ ʏᴇᴀʜ, {first}!",
    "✦ ᴡᴇ ʜᴏᴘᴇ ᴛᴏ sᴇᴇ ʏᴏᴜ sᴏᴏɴ ᴀɢᴀɪɴ, {first}."
