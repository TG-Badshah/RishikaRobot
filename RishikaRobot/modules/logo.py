...
from RishikaRobot.modules.nightmode import button_row
from RishikaRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./RishikaRobot/resources/fonts/*")
