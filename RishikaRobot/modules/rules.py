...
import RishikaRobot.modules.sql.rules_sql as sql
from RishikaRobot import dispatcher
from RishikaRobot.modules.helper_funcs.chat_status import connection_status, user_admin
from RishikaRobot.modules.helper_funcs.string_handling import markdown_parser
...
def send_rules(update, chat_id, from_pm=False, dest_chat=None):
    ...
    try:
        ...
        if excp.message == "⬤ ᴄʜᴀᴛ ɴᴏᴛ ғᴏᴜɴᴅ." and from_pm:
            bot.send_message(
                dest_chat,
                "⬤ ᴛʜᴇ ʀᴜʟᴇs sʜᴏʀᴛᴄᴜᴛ ғᴏʀ ᴛʜɪs ᴄʜᴀᴛ ʜᴀsɴ'ᴛ ʙᴇᴇɴ sᴇᴛ ᴘʀᴏᴘᴇʀʟʏ! ᴀsᴋ ᴀᴅᴍɪɴs ᴛᴏ ғɪx ᴛʜɪs.\n● ᴍᴀʏʙᴇ ᴛʜᴇʏ ғᴏʀɢᴏᴛ ᴛʜᴇ ʜʏᴘʜᴇɴ ɪɴ ɪᴅ",
            )
            return
        else:
            raise
