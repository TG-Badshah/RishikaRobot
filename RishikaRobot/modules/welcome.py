...
import RishikaRobot
import RishikaRobot.modules.sql.welcome_sql as sql
...
from RishikaRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from RishikaRobot.modules.helper_funcs.msg_types import get_welcome_type
from RishikaRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from RishikaRobot.modules.log_channel import loggable
from RishikaRobot.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not RishikaRobot.ALLOW_CHATS:
