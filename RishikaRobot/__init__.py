...
if ENV:
    ...
    from RishikaRobot.config import Development as Config
...
pbot = Client("RishikaRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from RishikaRobot.modules.helper_funcs.handlers import (
